...
### الحالة
قيد التنفيذ — الجزء البرمجي الأساسي مستمر حتى اكتمال تحقق الأصول في البناء.
...
### ما تبقى لإغلاق المرحلة
- التحقق من نتائج CI والتحويل والتصدير Android.
- مراجعة فهرس الأصول الناتج والتأكد من تغطية الشخصيات والوحوش والمركوبات والأسلحة والبيئة.
- ربط الأصول المختارة فعليًا بالمشاهد المناسبة بدل الاكتفاء باكتشافها.
- إزالة أي Blockout متبقٍ عندما يوجد الأصل الحقيقي المناسب.
- تثبيت نتيجة المرحلة في هذا السجل بعد نجاح البناء والتحقق.
